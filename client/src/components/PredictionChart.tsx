...
export function PredictionChart({ data, isLoading }: PredictionChartProps) {
  ...
  if (isLoading) {
    return (
      <div className="w-full h-[500px] flex items-center justify-center bg-card/30 rounded-2xl border backdrop-blur-sm">
  ...
  return (
    <div className="w-full h-[500px] glass-panel p-6 rounded-2xl relative border shadow-2xl overflow-hidden">
