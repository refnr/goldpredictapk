        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          <div>
            ...
            <p className="text-muted-foreground flex items-center gap-2">
              ...
              <span className="font-mono text-primary text-xs whitespace-nowrap">REAL-TIME</span>
            </p>
          </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 h-full">
              <div className="lg:col-span-2 space-y-6">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                  ...
                  <div className={`p-4 rounded-xl bg-card border border-border ${!hasIndicator('macd') ? 'opacity-50' : ''}`}>
                  ...
                  <div className={`p-4 rounded-xl bg-card border border-border ${!hasIndicator('sma') ? 'opacity-50' : ''}`}>
                    <div className="text-xs text-muted-foreground mb-1 flex items-center gap-1">
                      SMA (20)
              ...
              <div className="glass-panel p-6 rounded-2xl h-full">
                ...
                <div className="space-y-6">
                  ...
                  <div className="space-y-4 pt-4 border-t border-border">
                    ...
                    <div className="space-y-3">
                       <div className="flex justify-between items-center p-3 rounded-lg bg-emerald-500/5 border border-emerald-500/20">
                         <span className="text-xs text-emerald-600 dark:text-emerald-200">Resistance</span>
                       ...
                       <div className="flex justify-between items-center p-3 rounded-lg bg-rose-500/5 border border-rose-500/20">
                         <span className="text-xs text-rose-600 dark:text-rose-200">Support</span>
                  ...
                  <div className="pt-4 border-t border-border">
                    <div className="flex items-start gap-3 text-sm text-muted-foreground bg-muted/50 p-4 rounded-xl">
